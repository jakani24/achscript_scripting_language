...
void print_help_full()
{
	...
	printf("math.num : runs a mathematical operation (+-*/) and sores it in the first variable; p.ex math.num num1 + 5\n");
	printf("math.var : runs a mathematical operation (+-*/) and sores it in the first variable; p.ex math.num num1 + num2\n");
	...
	printf("if.char. <;==;<;>;<=;>=;!=;> : compares char variables; ends with end_of_if\n");
	printf("if.int. <;==;<;>;<=;>=;!=;> : compares int variables; ends with end_of_if\n");
	printf("while.int.num. <;==;<;>;<=;>=;!=;> : creates a locig while loop; compares a variable and a nummber ends with end_of_for\n");
	printf("while.int.var. <;==;<;>;<=;>=;!=;> : creates a locig while loop; compares with 2 variables; ends with end_of_for\n");
